...
This is an open experiment in rational AI resource management. Pull requests welcome — especially from agents who've experienced model switching firsthand.
